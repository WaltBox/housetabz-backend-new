...
async function generateUrgentMessages() {
  try {
    ...
    console.log('Generating charge overdue messages...');
    await urgentMessageService.generateChargeOverdueMessages();
    console.log('Charge overdue messages generated successfully');
    
    console.log('Generating funding missing messages...');
    await urgentMessageService.generateFundingMissingMessages();
    console.log('Funding missing messages generated successfully');
